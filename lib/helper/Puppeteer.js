...
async function findClickable(matcher, locator) {
  ...
  let els;
  const locatorValue = escapeRe(locator.value);
  const literal = xpathLocator.literal(locatorValue);
  ...
  return findElements.call(this, matcher, locatorValue); // by css or xpath
}
